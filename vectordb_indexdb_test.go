...
func TestIndexDB_Search_IncludeExcludeTags(t *testing.T)    { testSearch_IncludeExcludeTags(t, indexdbConn) }
...
func TestIndexDB_Search_DoesNotRewriteCorpus(t *testing.T) { testSearch_DoesNotRewriteCorpus(t, indexdbConn) }
func TestIndexDB_Reopen_LoadsIndex(t *testing.T)            { testReopen_LoadsIndex(t, indexdbConn) }
func TestIndexDB_Reopen_ModelMismatchFails(t *testing.T)    { testReopen_ModelMismatchFails(t, indexdbConn) }
func TestIndexDB_Reopen_DimMismatchFails(t *testing.T)      { testReopen_DimMismatchFails(t, indexdbConn) }
func TestIndexDB_Delete_RemovesFromResults(t *testing.T)    { testDelete_RemovesFromResults(t, indexdbConn) }
func TestIndexDB_Evict_LeastUsedOldestFirst(t *testing.T)   { testEvict_LeastUsedOldestFirst(t, indexdbConn) }
